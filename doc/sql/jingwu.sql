...
CREATE TABLE `add_point`  (
  ...
  `userId` int(4) NULL DEFAULT NULL COMMENT '加分人Id',
...
CREATE TABLE `delete_point`  (
  ...
  `userId` int(4) NULL DEFAULT NULL COMMENT '被扣分人Id',
...
CREATE TABLE `punish`  (
  ...
  `userId` int(4) NULL DEFAULT NULL COMMENT '被惩罚人Id',
...
CREATE TABLE `user_wj`  (
  ...
  `userId` int(4) NULL DEFAULT NULL COMMENT '违纪人Id',
