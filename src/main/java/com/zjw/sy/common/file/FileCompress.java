package com.zjw.sy.common.file;
...
public class FileCompress {
    ...
    /**
     * Description 将存放在sourceFilePath目录下的源文件，打包成fileName名称的zip文件，并存放到zipFilePath路径下
     *
    ...
    /**
     * Description 删除文件夹及文件夹下面的所有文件
     *
     * @param oldPath oldPath
     * @author ZhengJiawei
     * @date 2019-03-19 09:39:48
     */
